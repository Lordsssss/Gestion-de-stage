  ...
  return (
    <div className="EspaceEtudiant">
      ...
      <p>
        ...
        NomFamillePrenom.ZIP (pas d'espace, ni d'accent dans le nom du
        fichier)Contacter les employeurs pour leur proposer vos services Pour
        chaque employeur que vous contactez vous devez inscrire ses coordonnées
        sur le formulaire (Fichier en format Word)
      </p>
      <p>
        ...
        un par employeur rencontré. Au plus tard le vendredi 2 novembre à 12h00:
      ...
      <h2>Sites Web pour vous aider:</h2>
      <p>
        À l'hiver Pour comprendre le fonctionnement général des projets de fin
        d'études (stages) je vous invite à consulter les différentes sections du
        site Web dans le menu de droite. Lisez ce document concernant
      ...
      <p>Déroulement des stages / Horaire de travail
