    ...
    <div className="Accueil">
      ...
      <div className="accueil-flex-container">
        <div className="accueil-flex-item-card">
          ...
          <h2>Étudiants</h2>
          <span>À la fin de leurs études, les étudiants sont appelés à mettre en
          ...
          accueillent afin de finaliser leurs formations.</span>
          <NavLink className="accueil-flex-item-links" to="/EspaceEtudiant">Espace Étudiant <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-arrow-right arrow-icon" viewBox="0 0 16 16">
        ...
        <div className="accueil-flex-item-card">
          ...
          <h2>Employeurs</h2>
          <span>Le Collège Montmorency offre ainsi aux employeurs l'occasion d'obtenir
          une main-d'œuvre compétente, tout en leur permettant de participer à
          la formation finale des étudiants. Le stage de fin d'études est une
          expérience concrète permettant d'acquérir une expérience
          professionnelle formatrice.</span>
          <NavLink className="accueil-flex-item-links" to="/EspaceEmployeur">Espace Employeur <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-arrow-right arrow-icon" viewBox="0 0 16 16">
          <path fill-rule="evenodd" d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8z"/>
        </svg></NavLink>
        </div>
        <div className="accueil-flex-item-card">
          ...
          <h2>Compétences</h2>
          <span className="accueil-flex-item-text">Les étudiants terminent la portion académique de leurs études en
          informatique selon une des deux voies de sortie du programme: Réseaux
          et sécurité informatique Développement d'applications informatiques</span>
          <NavLink className="accueil-flex-item-links" to="/ProfilStagiaires">Profils stagiaires <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-arrow-right arrow-icon" viewBox="0 0 16 16">
          <path fill-rule="evenodd" d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8z"/>
        </svg></NavLink>
        </div>
      </div>
